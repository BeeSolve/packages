...
- d3ad659: Notify instead of leaking on unregistered sign-in, and make `UnsuccessfulAuth` a discriminated union on `code`.
...
- c769f00: Refactor `Accounts.getOne` to a props object and tidy internal error handling.
...
- f491d6b: Add user impersonation support.
...
- Updated dependencies [b9696d1]
  - @beesolve/dynamo-helpers@0.2.0
